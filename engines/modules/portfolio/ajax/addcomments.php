...
require_once ENGINE_DIR . '/modules/portfolio/addcomments.php';
...
if( $CN_HALT != TRUE )
{
	...
	$comments->query =
		"SELECT " .
			...
			PREFIX . "_portfolio_comments.email as gast_email, text, ip, is_register, name, " . USERPREFIX . "_users.email, news_num, comm_num, user_group, reg_date, signature, foto, fullname, land, icq, xfields

		FROM " . PREFIX . "_portfolio_comments
		LEFT JOIN " . USERPREFIX . "_users
		ON " . PREFIX . "_portfolio_comments.user_id=" . USERPREFIX . "_users.user_id
		WHERE " . PREFIX . "_portfolio_comments.portfolio_id = '$post_id' order by id DESC";

	$comments->build_comments('/portfolio/comments.tpl', 'ajax' );
