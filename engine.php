...
if (!isset ( $subaction ) AND isset ($_REQUEST['subaction']) ) $subaction = $_REQUEST['subaction']; else $subaction = "";
...
switch ( $do ) {
        case "portfolio" :
		require_once ENGINE_DIR . '/modules/portfolio/index.php';
		break;
	case "points" :
		include ENGINE_DIR . '/modules/points.php';
			break;
	case "gifts" :
		include ENGINE_DIR . '/modules/points/gifts.php';
			break;
	case "uref" :
		include ENGINE_DIR . '/modules/points/refer.php';
			break;
...
if ($nam_e) {
	...
	$metatags['title'] = $titl_e . $page_extra . ' рецепт :) ';
